...
import com.brx.botwa.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        if (mClient.isTerminalViewSelected()) {
            if (mClient.shouldEnforceCharBasedInput()) {
                ...
                // https://github.com.brx.botwa/botwa-app/issues/686
                ...
                // https://github.com.brx.botwa/botwa-packages/issues/25
                // https://github.com.brx.botwa/botwa-app/issues/87.
                // https://github.com.brx.botwa/botwa-app/issues/126.
                // https://github.com.brx.botwa/botwa-app/issues/137 (japanese chars and TYPE_NULL).
        ...
        // keyboard on Android TV (see https://github.com.brx.botwa/botwa-app/issues/221).
     ...
     * https://github.com.brx.botwa/botwa-app/pull/2237
     * https://github.com/agnostic-apollo/botwa-app/blob/terminal-code-point-custom-mapping/terminal-view/src/main/java/com.brx.botwa/view/TerminalView.java
     *
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        // https://github.com.brx.botwa/botwa-app/issues/731
     ...
     * {@link com.brx.botwa.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.brx.botwa.app.BotWAActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
