...
import com.brx.botwa.shared.file.filesystem.FileType;
...
import com.brx.botwa.shared.botwa.BotWAConstants.TERMUX_APP.RUN_COMMAND_SERVICE;
 ...
 * plugins that contains info on command execution and forwards the extras to {@link BotWAService}
 * for the actual execution.
 *
 * Check https://github.com.brx.botwa/botwa-app/wiki/RUN_COMMAND-Intent for more info.
 */
public class RunCommandService extends Service {
        ...
        */
        ...
        if (replaceCommaAlternativeCharsInArguments) {
            ...
            if (commaAlternativeCharsInArguments == null)
                commaAlternativeCharsInArguments = BotWAConstants.COMMA_ALTERNATIVE;
            // Replace any commaAlternativeCharsInArguments characters with normal commas
            DataUtils.replaceSubStringsInStringArrayItems(executionCommand.arguments, commaAlternativeCharsInArguments, BotWAConstants.COMMA_NORMAL);
        }
        ...
        // user knows someone tried to run a command in botwa context, since it may be malicious
        ...
        errmsg = BotWAPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(this, LOG_TAG);
        if (errmsg != null) {
            executionCommand.setStateFailed(Errno.ERRNO_FAILED.getCode(), errmsg);
            BotWAPluginUtils.processPluginExecutionCommandError(this, LOG_TAG, executionCommand, true);
            return stopService();
        }
        ...
        executionCommand.executable = BotWAFileUtils.getCanonicalPath(executionCommand.executable, null, true);
        ...
        if (executionCommand.workingDirectory != null && !executionCommand.workingDirectory.isEmpty()) {
            ...
            executionCommand.workingDirectory = BotWAFileUtils.getCanonicalPath(executionCommand.workingDirectory, null, true);
            ...
            // under allowed botwa working directory paths.
            // We try to set execute permissions, but ignore if they are missing, since only read and write permissions are required
            // for working directories.
            error = BotWAFileUtils.validateDirectoryFileExistenceAndPermissions("working", executionCommand.workingDirectory,
                true, true, true,
                false, true);
            if (error != null) {
                executionCommand.setStateFailed(error);
        ...
        executableExtra = BotWAFileUtils.getExpandedBotWAPath(executableExtra);
        ...
        execIntent.setClass(this, BotWAService.class);
    ...
    private void runStartForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            startForeground(BotWAConstants.TERMUX_RUN_COMMAND_NOTIFICATION_ID, buildNotification());
        }
    }
    ...
    private Notification buildNotification() {
        ...
        Notification.Builder builder =  NotificationUtils.geNotificationBuilder(this,
            BotWAConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID, Notification.PRIORITY_LOW,
            BotWAConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, null, null,
    ...
    private void setupNotificationChannel() {
        ...
        NotificationUtils.setupNotificationChannel(this, BotWAConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID,
            BotWAConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, NotificationManager.IMPORTANCE_LOW);
    }
