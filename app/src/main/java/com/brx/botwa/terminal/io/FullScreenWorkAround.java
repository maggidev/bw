...
/**
 * Work around for fullscreen mode in BotWA to fix ExtraKeysView not being visible.
...
public class FullScreenWorkAround {
    ...
    public static void apply(BotWAActivity activity) {
        new FullScreenWorkAround(activity);
    }

    private FullScreenWorkAround(BotWAActivity activity) {
