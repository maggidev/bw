...
public class BotWAOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "BotWAOpenReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Uri uriToShare = UriUtils.getContentUri(BotWAConstants.TERMUX_FILE_SHARE_URI_AUTHORITY, fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        private static final String LOG_TAG = "BotWAContentProvider";
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(BotWAConstants.TERMUX_FILES_DIR_PATH) || path.startsWith(storagePath))) {
                    throw new IllegalArgumentException("Invalid path: " + path);
                }

                // If BotWAConstants.PROP_ALLOW_EXTERNAL_APPS property to not set to "true", then throw exception
                String errmsg = BotWAPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(getContext(), LOG_TAG);
                if (errmsg != null) {
                ...
                // BotWAConstants.PROP_ALLOW_EXTERNAL_APPS set by users without their explicit consent.
                if (BotWAConstants.TERMUX_PROPERTIES_FILE_PATHS_LIST.contains(path) ||
                    BotWAConstants.TERMUX_FLOAT_PROPERTIES_FILE_PATHS_LIST.contains(path)) {
                    mode = "r";
                }
