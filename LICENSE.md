The `botwa/botwa-app` repository is released under [GPLv3 only](https://www.gnu.org/licenses/gpl-3.0.html) license.
...
- Check [`botwa-shared/LICENSE.md`](botwa-shared/LICENSE.md) for `botwa-shared` library related exceptions.
