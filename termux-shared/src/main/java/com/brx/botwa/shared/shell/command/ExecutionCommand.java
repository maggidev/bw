package com.brx.botwa.shared.shell.command;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the BotWA app
    perspective.
    */
     ...
     * commands. By default, @link com.brx.botwa.shared.shell.StreamGobbler} only logs stdout and
    ...
    /** Defines the markdown text for the help of the BotWA plugin API that was used to start the
     ...
     * like with an intent or from within BotWA app itself. */
