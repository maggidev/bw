package com.brx.botwa.shared.botwa.terminal;
...
public class BotWATerminalSessionClientBase implements TerminalSessionClient {

    public BotWATerminalSessionClientBase() {
    }
