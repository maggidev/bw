...
public class BotWAAppSharedPreferences extends AppSharedPreferences {

    private int MIN_FONTSIZE;
    private int MAX_FONTSIZE;
    private int DEFAULT_FONTSIZE;

    private static final String LOG_TAG = "BotWAAppSharedPreferences";

    private BotWAAppSharedPreferences(@NonNull Context context) {
        super(context,
            SharedPreferenceUtils.getPrivateSharedPreferences(context,
                BotWAConstants.TERMUX_DEFAULT_PREFERENCES_FILE_BASENAME_WITHOUT_EXTENSION),
    ...
    /**
     * Get {@link BotWAAppSharedPreferences}.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the
     *                {@link BotWAConstants#TERMUX_PACKAGE_NAME}.
     * @return Returns the {@link BotWAAppSharedPreferences}. This will {@code null} if an exception is raised.
     */
    @Nullable
    public static BotWAAppSharedPreferences build(@NonNull final Context context) {
        Context botwaPackageContext = PackageUtils.getContextForPackage(context, BotWAConstants.TERMUX_PACKAGE_NAME);
        if (botwaPackageContext == null)
            return null;
        else
            return new BotWAAppSharedPreferences(botwaPackageContext);
    }
     ...
     * @return Returns the {@link BotWAAppSharedPreferences}. This will {@code null} if an exception is raised.
     */
    public static BotWAAppSharedPreferences build(@NonNull final Context context, final boolean exitAppOnError) {
        Context botwaPackageContext = BotWAUtils.getContextForPackageOrExitApp(context, BotWAConstants.TERMUX_PACKAGE_NAME, exitAppOnError);
        if (botwaPackageContext == null)
            return null;
        else
            return new BotWAAppSharedPreferences(botwaPackageContext);
