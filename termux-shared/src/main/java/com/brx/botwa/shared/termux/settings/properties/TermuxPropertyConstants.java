 ...
 *
 * - 0.14.0 (2021-09-02)
 *      - Add `getBotWAFloatPropertiesFile()`.
 *
 * - 0.15.0 (2021-09-05)
...
/**
 * A class that defines shared constants of the SharedProperties used by BotWA app and its plugins.
 ...
 * {@link BotWAConstants#TERMUX_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link BotWAConstants#TERMUX_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class BotWAPropertyConstants {

    private static final String LOG_TAG = "BotWAPropertyConstants";
    ...
    /** Defines the key for whether to hide soft keyboard when botwa app is started */
    ...
    /** Defines the key for whether the {@link BotWAAmSocketServer} should be run at app startup */
    public static final String KEY_RUN_TERMUX_AM_SOCKET_SERVER =  "run-botwa-am-socket-server"; // Default: "run-botwa-am-socket-server"
     ...
     * deleted from $TMPDIR on botwa exit.
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = BotWAConstants.TERMUX_HOME_DIR_PATH;
    ...
    /** Defines the set for keys loaded by botwa
    ...
    public static final Set<String> TERMUX_APP_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        ...
        BotWAConstants.PROP_ALLOW_EXTERNAL_APPS,
    ...
    /** Defines the set for keys loaded by botwa that have default boolean behaviour with false as default.
     * "true" -> true
     * "false" -> false
     * default: false
     */
    ...
    /** Defines the set for keys loaded by botwa that have default boolean behaviour with true as default.
     * "true" -> true
     * "false" -> false
     * default: true
     */
    ...
    /** Defines the set for keys loaded by botwa that have default inverted boolean behaviour with false as default.
     * "false" -> true
     * "true" -> false
     * default: false
     */
    ...
    /** Defines the set for keys loaded by botwa that have default inverted boolean behaviour with true as default.
     * "false" -> true
     * "true" -> false
     * default: true
     */
