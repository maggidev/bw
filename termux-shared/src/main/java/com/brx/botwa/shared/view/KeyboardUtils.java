package com.brx.botwa.shared.view;
...
public class KeyboardUtils {
    ...
    public static boolean shouldSoftKeyboardBeDisabled(final Context context, final boolean isSoftKeyboardEnabled, final boolean isSoftKeyboardEnabledOnlyIfNoHardware) {
        ...
        if (!isSoftKeyboardEnabled) {
            ...
            /*
             * Currently, for this case, soft keyboard will be disabled on BotWA app startup and
             ...
             * BotWA app is switched to another app. After returning back, keyboard will be disabled
             * until toggle is pressed again.
             * This may also be helpful for the Lineage OS bug where if "Show soft keyboard" toggle
             * in "Language and Input" is disabled and BotWA is started without a hardware keyboard
             * in landscape mode, and then the keyboard is connected and phone is rotated to portrait
             * mode and then keyboard is toggled with BotWA keyboard toggle buttons, then a blank
             ...
             * https://github.com.brx.botwa/botwa-app/issues/1995#issuecomment-837080079
             */
