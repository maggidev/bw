package com.brx.botwa.shared.activities;
 ...
 * {@code `<activity android:name="com.brx.botwa.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.BotWAReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.brx.botwa.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(BotWAConstants.TERMUX_APP_NAME + " App Report");
        }
